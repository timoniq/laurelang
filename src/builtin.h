...
const laure_builtin_predicate BUILTIN_PREDICATES[] = {
    ...
    {"__bag", laure_predicate_bag, 2, "builtin bag", {"src:_ container:_"}, false},
    {"__bag_sz", laure_predicate_bag, 3, "builtin bag sized", {"src:_ container:_ size:int"}, false},
    ...
    {"__append", laure_predicate_append, 2, "builtin array append predicate", {"to_arr:_ with_arr:_", "_"}, false},
    ...
    {"__instantiated", laure_constraint_instantiated, 1, "builtin instantiated constraint", {"x:_", NULL}, true},
};
